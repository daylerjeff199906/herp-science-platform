...
export function HeroSlider({ slides = [] }: HeroSliderProps) {
    const defaultSlide: HeroSlide = {
        ...
        ctaLabel: "Explorar",
        clickArea: 'full' // Default behavior
    }
                                            ...
                                            <CardContent className="relative z-20 flex flex-col justify-end h-full p-6 md:p-10 lg:px-16 max-w-2xl">
                                                ...
                                                {slide.href && (
                                                    isButtonClick ? (
                                                        ...
                                                        <div className={cn(
                                                            "flex items-center text-primary font-medium transition-transform",
                                                            isFullClick && "group-hover:translate-x-1"
                                                        )}>
                                                            {slide.ctaLabel || "Ver más"}
                                                            <ArrowRight className="ml-2 h-4 w-4" />
                                                        </div>
